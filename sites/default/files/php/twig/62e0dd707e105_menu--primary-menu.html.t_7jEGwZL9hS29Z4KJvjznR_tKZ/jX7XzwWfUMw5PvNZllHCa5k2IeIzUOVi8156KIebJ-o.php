...
class __TwigTemplate_2bc8327a16e41c96d5327b07972e9bf61e6cfec2adb351f444af71e354ea260e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["is_top_level_menu"] ?? null) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "C:\\xampp\\htdocs\\demoproject\\core\\themes\\olivero\\templates\\navigation\\menu--primary-menu.html.twig");
    }
